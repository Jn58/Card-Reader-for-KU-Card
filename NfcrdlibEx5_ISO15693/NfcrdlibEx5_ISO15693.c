...
static phStatus_t phApp_Init(void);
...
int main (void)
{
    do
    {
        ...
        phOsal_ThreadCreate(&Iso15693.ThreadHandle, &Iso15693, &NfcrdlibEx5_ISO15693, NfcrdlibEx5_ISO15693);
...
static phStatus_t phApp_Init(void)
{
    ...
    /* Read Chip Version */
#if defined NXPBUILD__PHHAL_HW_RC663
    status = phhalHw_Rc663_ReadRegister(&sPlatform.sHal, PHHAL_HW_RC663_REG_VERSION, &bChipVersion);
    CHECK_STATUS(status);
