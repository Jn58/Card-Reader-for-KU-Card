            _____________________________________________________
              ...
              NXPNFCRDLIB EXAMPLE : NFCRDLIBEX6_EMVCO_LOOPBACK
                             (V4.040.05.011646)
            _____________________________________________________
...
1 Document Purpose
2 Description of the NfcrdlibEx6_EMVCo_Loopback
3 Restrictions on NfcrdlibEx6_EMVCo_Loopback
4 Package Contents
...
==================
  ...
  NfcrdlibEx6_EMVCo_Loopback example as well as it's known problems and
  restrictions.
...
===============================================
  ...
  This example is a LoopBack Application which is used to perform
  EMVCo2.5(L1) digital compliance validation.


3 Restrictions on NfcrdlibEx6_EMVCo_Loopback
============================================

  - NfcrdlibEx6_EMVCo_Loopback is restricted to be run on NFC Reader
...
==================
  ...
  - NfcrdlibEx6_EMVCo_Loopback.c
    + Main example file.
  - intfs/NfcrdlibEx6_EMVCo_Loopback.h
