...
========================================
  ...
  - NfcrdlibEx9_NTagI2C can be run with PNEV512B, CLEV663B, PN5180 and
    PN7462AU.  (See Section-9 for supported versions)
...
=================
  ...
  8) Run the application and when you bring the NTag I2C in proximity, the
