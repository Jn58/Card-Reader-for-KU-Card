...
==============================================
  ...
  - NfcrdlibEx7_EMVCo_Polling can be run with PNEV512B, CLEV663B, PN5180 and
    PN7462AU.  (See Section-10 for supported versions)
  - This example performs the EMVCo Polling loop.
  - Upon activation of the detected card, the example shall send a Select
    PPSE command.
  - It displays/prints the response from the card for the select PPSE
    command.
...
===========================================
  ...
  - NfcrdlibEx7_EMVCo_Polling is restricted to be run on NFC Reader
...
=============================================
  ...
  - The example application is written to perform a polling loop and upon
    ...
    command.
  - The response data within a limit of 256 bytes shall be displayed as a
  ...
  - The following #defines can be used/configured to enable the different P2
    ...
    - #define PPSE_NO_LE: P2:000011xxb (No data recieved in the PPSE
       response )
...
=================
  ...
  1) This application is for displaying the response recieved for PPSE select
     command.
